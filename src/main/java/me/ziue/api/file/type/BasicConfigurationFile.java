package me.ziue.api.file.type;

import com.google.common.io.Files;
import me.ziue.api.file.AbstractConfigurationFile;
...
public class BasicConfigurationFile extends AbstractConfigurationFile {
    ...
    public void reload() {
        File file = new File(License.getLicense().getDataFolder(), getName() + ".yml");
        try {
    ...
    public void save() {
        File folder = License.getLicense().getDataFolder();
        try {
